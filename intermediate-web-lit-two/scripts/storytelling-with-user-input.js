...
function fillBlanks() {
	...
	document.getElementById("story-space").innerHTML = "<div><p style='font-size: 3em;'>In the early days of the " + firstWord + " people used to " + secondWord + " email by " + thirdWord + ". They would hit the send button and then wait for " + fourthWord + " until the computer said, '" + fifthWord + ", you've got mail!' Back then, there were a lot of spam emails about " + sixthWord + ".</p><p><button onClick='resetPage()'>Reset</button></p></div>"
}
