...
document.getElementById('myTrueName').innerHTML = "<div>" + this.name + ", you are now <span style='color:#903;'>" + this.altName + ", the " + this.adjective + " " + this.class + " of " + this.origin + ".</div>"
